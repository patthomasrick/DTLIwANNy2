...
def _swig_setattr_nondynamic(self, class_type, name, value, static=1):
    ...
    if (name == "this"):
        if type(value).__name__ == 'SwigPyObject':
            self.generate_data_dict[name] = value
            return
...
class training_data_parent(_object):
    ...
    def read_train_from_file(self, *args):
        return _libfann.training_data_parent_read_train_from_file(self, *args)

    def save_train(self, *args):
        return _libfann.training_data_parent_save_train(self, *args)

    def save_train_to_fixed(self, *args):
        return _libfann.training_data_parent_save_train_to_fixed(self, *args)

    def shuffle_train_data(self):
        return _libfann.training_data_parent_shuffle_train_data(self)

    def merge_train_data(self, *args):
        return _libfann.training_data_parent_merge_train_data(self, *args)
    ...
    def set_train_data(self, *args):
        return _libfann.training_data_parent_set_train_data(self, *args)

    def create_train_from_callback(self, *args):
        return _libfann.training_data_parent_create_train_from_callback(self, *args)

    def scale_input_train_data(self, *args):
        return _libfann.training_data_parent_scale_input_train_data(self, *args)

    def scale_output_train_data(self, *args):
        return _libfann.training_data_parent_scale_output_train_data(self, *args)

    def scale_train_data(self, *args):
        return _libfann.training_data_parent_scale_train_data(self, *args)

    def subset_train_data(self, *args):
        return _libfann.training_data_parent_subset_train_data(self, *args)
...
class neural_net_parent(_object):
    ...
    def create_standard(self, *args):
        return _libfann.neural_net_parent_create_standard(self, *args)

    def create_standard_array(self, *args):
        return _libfann.neural_net_parent_create_standard_array(self, *args)

    def create_sparse(self, *args):
        return _libfann.neural_net_parent_create_sparse(self, *args)

    def create_sparse_array(self, *args):
        return _libfann.neural_net_parent_create_sparse_array(self, *args)

    def create_shortcut(self, *args):
        return _libfann.neural_net_parent_create_shortcut(self, *args)

    def create_shortcut_array(self, *args):
        return _libfann.neural_net_parent_create_shortcut_array(self, *args)

    def run(self, *args):
        return _libfann.neural_net_parent_run(self, *args)

    def randomize_weights(self, *args):
        return _libfann.neural_net_parent_randomize_weights(self, *args)

    def init_weights(self, *args):
        return _libfann.neural_net_parent_init_weights(self, *args)

    def print_connections(self):
        return _libfann.neural_net_parent_print_connections(self)

    def create_from_file(self, *args):
        return _libfann.neural_net_parent_create_from_file(self, *args)

    def save(self, *args):
        return _libfann.neural_net_parent_save(self, *args)

    def save_to_fixed(self, *args):
        return _libfann.neural_net_parent_save_to_fixed(self, *args)

    def train(self, *args):
        return _libfann.neural_net_parent_train(self, *args)

    def train_epoch(self, *args):
        return _libfann.neural_net_parent_train_epoch(self, *args)

    def train_on_data(self, *args):
        return _libfann.neural_net_parent_train_on_data(self, *args)
    ...
    def test_data(self, *args):
        return _libfann.neural_net_parent_test_data(self, *args)
    ...
    def set_callback(self, *args):
        return _libfann.neural_net_parent_set_callback(self, *args)
    ...
    def set_training_algorithm(self, *args):
        return _libfann.neural_net_parent_set_training_algorithm(self, *args)

    def get_learning_rate(self):
        return _libfann.neural_net_parent_get_learning_rate(self)

    def set_learning_rate(self, *args):
        return _libfann.neural_net_parent_set_learning_rate(self, *args)

    def get_activation_function(self, *args):
        return _libfann.neural_net_parent_get_activation_function(self, *args)

    def set_activation_function(self, *args):
        return _libfann.neural_net_parent_set_activation_function(self, *args)

    def set_activation_function_layer(self, *args):
        return _libfann.neural_net_parent_set_activation_function_layer(self, *args)

    def set_activation_function_hidden(self, *args):
        return _libfann.neural_net_parent_set_activation_function_hidden(self, *args)

    def set_activation_function_output(self, *args):
        return _libfann.neural_net_parent_set_activation_function_output(self, *args)

    def get_activation_steepness(self, *args):
        return _libfann.neural_net_parent_get_activation_steepness(self, *args)

    def set_activation_steepness(self, *args):
        return _libfann.neural_net_parent_set_activation_steepness(self, *args)

    def set_activation_steepness_layer(self, *args):
        return _libfann.neural_net_parent_set_activation_steepness_layer(self, *args)

    def set_activation_steepness_hidden(self, *args):
        return _libfann.neural_net_parent_set_activation_steepness_hidden(self, *args)

    def set_activation_steepness_output(self, *args):
        return _libfann.neural_net_parent_set_activation_steepness_output(self, *args)

    def get_train_error_function(self):
        return _libfann.neural_net_parent_get_train_error_function(self)

    def set_train_error_function(self, *args):
        return _libfann.neural_net_parent_set_train_error_function(self, *args)

    def get_quickprop_decay(self):
        return _libfann.neural_net_parent_get_quickprop_decay(self)

    def set_quickprop_decay(self, *args):
        return _libfann.neural_net_parent_set_quickprop_decay(self, *args)

    def get_quickprop_mu(self):
        return _libfann.neural_net_parent_get_quickprop_mu(self)

    def set_quickprop_mu(self, *args):
        return _libfann.neural_net_parent_set_quickprop_mu(self, *args)

    def get_rprop_increase_factor(self):
        return _libfann.neural_net_parent_get_rprop_increase_factor(self)

    def set_rprop_increase_factor(self, *args):
        return _libfann.neural_net_parent_set_rprop_increase_factor(self, *args)

    def get_rprop_decrease_factor(self):
        return _libfann.neural_net_parent_get_rprop_decrease_factor(self)

    def set_rprop_decrease_factor(self, *args):
        return _libfann.neural_net_parent_set_rprop_decrease_factor(self, *args)

    def get_rprop_delta_min(self):
        return _libfann.neural_net_parent_get_rprop_delta_min(self)

    def set_rprop_delta_min(self, *args):
        return _libfann.neural_net_parent_set_rprop_delta_min(self, *args)

    def get_rprop_delta_max(self):
        return _libfann.neural_net_parent_get_rprop_delta_max(self)

    def set_rprop_delta_max(self, *args):
        return _libfann.neural_net_parent_set_rprop_delta_max(self, *args)
    ...
    def get_layer_array(self, *args):
        return _libfann.neural_net_parent_get_layer_array(self, *args)

    def get_bias_array(self, *args):
        return _libfann.neural_net_parent_get_bias_array(self, *args)

    def get_connection_array(self, *args):
        return _libfann.neural_net_parent_get_connection_array(self, *args)

    def set_weight_array(self, *args):
        return _libfann.neural_net_parent_set_weight_array(self, *args)

    def set_weight(self, *args):
        return _libfann.neural_net_parent_set_weight(self, *args)

    def get_learning_momentum(self):
        return _libfann.neural_net_parent_get_learning_momentum(self)

    def set_learning_momentum(self, *args):
        return _libfann.neural_net_parent_set_learning_momentum(self, *args)

    def get_train_stop_function(self):
        return _libfann.neural_net_parent_get_train_stop_function(self)

    def set_train_stop_function(self, *args):
        return _libfann.neural_net_parent_set_train_stop_function(self, *args)

    def get_bit_fail_limit(self):
        return _libfann.neural_net_parent_get_bit_fail_limit(self)

    def set_bit_fail_limit(self, *args):
        return _libfann.neural_net_parent_set_bit_fail_limit(self, *args)

    def get_bit_fail(self):
        return _libfann.neural_net_parent_get_bit_fail(self)

    def cascadetrain_on_data(self, *args):
        return _libfann.neural_net_parent_cascadetrain_on_data(self, *args)

    def cascadetrain_on_file(self, *args):
        return _libfann.neural_net_parent_cascadetrain_on_file(self, *args)

    def get_cascade_output_change_fraction(self):
        return _libfann.neural_net_parent_get_cascade_output_change_fraction(self)

    def set_cascade_output_change_fraction(self, *args):
        return _libfann.neural_net_parent_set_cascade_output_change_fraction(self, *args)

    def get_cascade_output_stagnation_epochs(self):
        return _libfann.neural_net_parent_get_cascade_output_stagnation_epochs(self)

    def set_cascade_output_stagnation_epochs(self, *args):
        return _libfann.neural_net_parent_set_cascade_output_stagnation_epochs(self, *args)
    ...
    def set_cascade_weight_multiplier(self, *args):
        return _libfann.neural_net_parent_set_cascade_weight_multiplier(self, *args)

    def get_cascade_candidate_limit(self):
        return _libfann.neural_net_parent_get_cascade_candidate_limit(self)

    def set_cascade_candidate_limit(self, *args):
        return _libfann.neural_net_parent_set_cascade_candidate_limit(self, *args)

    def get_cascade_max_out_epochs(self):
        return _libfann.neural_net_parent_get_cascade_max_out_epochs(self)

    def set_cascade_max_out_epochs(self, *args):
        return _libfann.neural_net_parent_set_cascade_max_out_epochs(self, *args)

    def get_cascade_max_cand_epochs(self):
        return _libfann.neural_net_parent_get_cascade_max_cand_epochs(self)

    def set_cascade_max_cand_epochs(self, *args):
        return _libfann.neural_net_parent_set_cascade_max_cand_epochs(self, *args)
    ...
    def set_cascade_activation_functions(self, *args):
        return _libfann.neural_net_parent_set_cascade_activation_functions(self, *args)
    ...
    def set_cascade_activation_steepnesses(self, *args):
        return _libfann.neural_net_parent_set_cascade_activation_steepnesses(self, *args)

    def get_cascade_num_candidate_groups(self):
        return _libfann.neural_net_parent_get_cascade_num_candidate_groups(self)

    def set_cascade_num_candidate_groups(self, *args):
        return _libfann.neural_net_parent_set_cascade_num_candidate_groups(self, *args)

    def scale_train(self, *args):
        return _libfann.neural_net_parent_scale_train(self, *args)

    def descale_train(self, *args):
        return _libfann.neural_net_parent_descale_train(self, *args)

    def set_input_scaling_params(self, *args):
        return _libfann.neural_net_parent_set_input_scaling_params(self, *args)

    def set_output_scaling_params(self, *args):
        return _libfann.neural_net_parent_set_output_scaling_params(self, *args)

    def set_scaling_params(self, *args):
        return _libfann.neural_net_parent_set_scaling_params(self, *args)

    def clear_scaling_params(self):
        return _libfann.neural_net_parent_clear_scaling_params(self)

    def scale_input(self, *args):
        return _libfann.neural_net_parent_scale_input(self, *args)

    def scale_output(self, *args):
        return _libfann.neural_net_parent_scale_output(self, *args)

    def descale_input(self, *args):
        return _libfann.neural_net_parent_descale_input(self, *args)

    def descale_output(self, *args):
        return _libfann.neural_net_parent_descale_output(self, *args)

    def set_error_log(self, *args):
        return _libfann.neural_net_parent_set_error_log(self, *args)
...
class training_data(training_data_parent):
    ...
    def set_train_data(self, *args):
        return _libfann.training_data_set_train_data(self, *args)
...
class neural_net(neural_net_parent):
    ...
    def create_standard_array(self, *args):
        return _libfann.neural_net_create_standard_array(self, *args)

    def create_sparse_array(self, *args):
        return _libfann.neural_net_create_sparse_array(self, *args)

    def create_shortcut_array(self, *args):
        return _libfann.neural_net_create_shortcut_array(self, *args)

    def run(self, *args):
        return _libfann.neural_net_run(self, *args)

    def train(self, *args):
        return _libfann.neural_net_train(self, *args)

    def test(self, *args):
        return _libfann.neural_net_test(self, *args)

    def get_layer_array(self, *args):
        return _libfann.neural_net_get_layer_array(self, *args)

    def get_bias_array(self, *args):
        return _libfann.neural_net_get_bias_array(self, *args)

    def get_connection_array(self, *args):
        return _libfann.neural_net_get_connection_array(self, *args)

    def set_weight_array(self, *args):
        return _libfann.neural_net_set_weight_array(self, *args)

    def get_cascade_activation_steepnesses(self):
        return _libfann.neural_net_get_cascade_activation_steepnesses(self)

    def set_cascade_activation_steepnesses(self, *args):
        return _libfann.neural_net_set_cascade_activation_steepnesses(self, *args)
